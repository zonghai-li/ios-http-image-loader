...
#define HTTPImageFileCachePermanentInterval     -1
#define HTTPImageFileCacheNoCache                0


@interface FilePersistence : NSObject <ImageCacheProtocol>

-(id) initWithPath: (NSString *)path;

// cacheInterval:  <0 permanent; 0 no cache; >0 cache interval in seconds
