...
@implementation UIImageView (HTTPImage)


-(void) setImageWithUrl:(NSString *)urlString useHTTPImageManager:(HTTPImageManager *)manager
{
    if( !manager ) return;
    [manager loadImage:[HTTPImageRequest requestWithURL:urlString 
                                              forUIView:self ]];
}
@end
